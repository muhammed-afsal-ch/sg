...
const ScoreBoard = () => {
  ...
  // Sort districts initially
  const sortedGrandTotal = Object.entries(districtTotals).sort((a, b) => b[1] - a[1]);
    ...
    <SafeAreaView className="px-4 my-6 bg-primary h-full">
      <ScrollView>
        ...
        <View>
          ...
          {(showAllGeneral ? sortedGeneralTotal : sortedGeneralTotal.slice(0, 3))
            .map(([districtId, total], index) => {
              const districtName = districtMap[districtId] || `District ${districtId}`;
              return (
        ...
        <View className='mb-10'>
          ...
          {(showAllTwalaba ? sortedTwalabaTotal : sortedTwalabaTotal.slice(0, 3))
            .map(([districtId, total], index) => {
              const districtName = districtMap[districtId] || `District ${districtId}`;
              return (
