...
import { View, Text, TouchableOpacity, Image, Alert, Modal, Dimensions,ActivityIndicator } from "react-native";
...
const PostCard = ({ caption, thumbnail }) => {
  ...
  const [imageHeight, setImageHeight] = useState(null); // Initialize to null, will be set once image is loaded
    ...
    <View className="flex flex-col items-center px-4 mb-14">
      ...
      >
        ...
        />
            ...
            <TouchableOpacity onPress={handleImageClick} className="absolute right-4 bottom-4">
      ...
      {imageHeight ? (
        <>
        <View  className="w-full mt-3 relative flex justify-center items-center"> 
         <Image
          source={{ uri: thumbnail }}
          className="w-full h-[100%] rounded-xl mt-3"
        ...
        <TouchableOpacity className="absolute right-4 bottom-4 bg-gray-400 p-2 rounded-full opacity-30" onPress={handleImageClick}>
